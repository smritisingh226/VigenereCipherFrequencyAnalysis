...
import itertools, re
import vigenereCiphere, frequencyAnalysis, detectEnglish
   ...
   # Determine the most likely letters for each letter in the key.
    ...
    for nth in range(1, mostLikelyKeyLength + 1):
        ...
        for possibleKey in LETTERS:
             decryptedText = vigenereCiphere.decryptMessage(possibleKey, nthLetters)
    ...
    for indexes in itertools.product(range(NUM_MOST_FREQ_LETTERS), repeat=mostLikelyKeyLength):
        ...
        decryptedText = vigenereCiphere.decryptMessage(possibleKey, ciphertextUp)
...
def hackVigenere(ciphertext):
    ...
    if not SILENT_MODE:
        ...
        print('The most likely key lengths are: ' + keyLengthStr + '\n')
